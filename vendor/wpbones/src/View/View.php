...
namespace WPXFollowgramLight\WPBones\View;
...
class View
{
  ...
  public function render()
  {
    ...
    $func = function () {
      ...
      if ( ! class_exists( 'WPXFollowgramLight\Html' ) ) {
        class_alias( '\WPXFollowgramLight\WPBones\Html\Html', 'WPXFollowgramLight\Html', true );
      }
