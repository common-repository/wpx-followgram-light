...
You can use [WPX Followgram Light](https://github.com/wpbones/WPXFollowgramLight) repo as a boilerplate to create a plugin.
...
You may start from [WPX Followgram Light](https://github.com/wpbones/WPXFollowgramLight) repo as a boilerplate to create a WP Bones WordPress plugin.
