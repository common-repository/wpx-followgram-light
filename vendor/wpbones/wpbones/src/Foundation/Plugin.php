...
use WPXFollowgramLight\WPBones\Foundation\Log\LogServiceProvider;
use WPXFollowgramLight\WPBones\Support\Str;
...
class Plugin extends Container implements PluginContract
{
    ...
    public function boot()
    {
        ...
        // Load text domain
        load_plugin_textdomain("wpx-followgram-light", false, trailingslashit(basename($this->basePath)) . $this->pluginData['DomainPath']);
                    ...
                    if (isset($subMenu['route']['load'])) {
                        ...
                        add_action(
                            ...
                            function () use ($controller, $method) {
                                $className = "WPXFollowgramLight\\Http\\Controllers\\{$controller}";
                                $instance  = new $className;
